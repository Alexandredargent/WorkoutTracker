...
import { View, Text, FlatList, TouchableOpacity, SafeAreaView, StatusBar, ActivityIndicator, TextInput, StyleSheet } from 'react-native';
...
const styles = StyleSheet.create({
  ...
  item: {
    ...
    backgroundColor: theme.colors.card,
    borderRadius: 10,
    marginBottom: theme.spacing.sm + 2, // 10
    shadowColor: theme.colors.shadow,
  ...
  itemIcon: {
    marginRight: theme.spacing.md - 1, // 15
  },
  itemTextContainer: {
    flex: 1,
  },
